...
export const tools: Tool[] = [
  {
    ...
    shortName: '물타기',
    purpose: '추가 매수 판단',
    description: '추가 매수 뒤 평균단가와 수수료 반영 체감 단가를 함께 계산합니다.',
    summary: '평균단가와 체감 단가를 함께 보는 추가 매수 계산기',
    icon: '➕',
  ...
  },
  {
    ...
    shortName: '수익률',
    purpose: '실손익 확인',
    description: '평가손익, 수익률, 수수료와 거래세를 반영한 실손익을 계산합니다.',
    summary: '평가손익과 실손익 계산기',
    icon: '📈',
